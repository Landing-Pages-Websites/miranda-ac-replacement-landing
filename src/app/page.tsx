          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="text-center mt-10 reveal">
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="#contact" className="inline-flex items-center justify-center bg-accent hover:bg-accent-light text-white font-bold px-8 py-4 rounded-lg text-base transition-all duration-300 transform hover:scale-105 shadow-lg shadow-accent/30">
